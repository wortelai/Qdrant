...
def add_vector_points(COLLECTION_NAME, dir_name):
...
def delete_vector_point(COLLECTION_NAME, vector_path):
...
def search_vector_point(COLLECTION_NAME, vector_path,limit=10, offset=0, threshold=0):
...
if __name__ == "__main__":
    ...
    if(choice==1):
        ...
        add_vector_points(COLLECTION_NAME, dir_name)
        ...
        response=delete_vector_point(COLLECTION_NAME,delete_image_path)
        print(f"Delete image fuction response response: {response}")
        ...
        response=search_vector_point(COLLECTION_NAME, search_img_path,1,0,0)
